...
@dataclass
class Volume:
    """Placeholder implementation for the Volume indicator."""

    lookback: int = 14

    def calculate(self, series: Sequence[float]) -> Optional[float]:
        """Return a single Volume value once implemented."""
        raise NotImplementedError("Implement the Volume calculation.")

    def calculate_series(self, series: Sequence[float]) -> List[Optional[float]]:
        """Return rolling Volume values once implemented."""
        raise NotImplementedError("Implement the rolling Volume calculation.")
